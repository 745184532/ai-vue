                ...
                <!-- 消息列表 -->
                 <div  v-for=" masg in message" :key="masg.id" :class="msg.senderType ===1 ? 'user-message' : 'ai-message'">
                    ...
                    <div class="message-content">
                        ...
                        <div class="message-time">{{ msg.senderType ===2 && isAiTying ? '正在回复中...' : msg.createdAt }}</div>
                    </div>
                 </div>
            </div>
            <!-- 消息回复区域 -->
...
import { ref, onMounted } from 'vue' // 记得导入 ref
