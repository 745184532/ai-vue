        ...
        <div class="content">
            ...
            <div class="diary-card">
                ...
                <div class="emotion-grid">
                    <div v-for="emotion in emotionOptions" :key="emotion.name" class="emotion-card" :class="{'selected': emotion.name===diaryForm.dominantEmotion}" @click="selectEmotion(emotion)">
            ...
            <div class="diary-card">
                ...
                <div class="detail-form">
                    <div class="form-group">
                        ...
                        <el-input v-model="diaryForm.emotionTriggers" placeholder="今天什么事情影响了您的情绪?" type="textarea" :rows="3" maxLength="1000" show-word-limit/>
                    </div>
                    <div class="form-group">
                        <div class="form-label">今日感想</div>
                        <el-input v-model="diaryForm.diaryContent" placeholder="写下您今天的想法、感受或发生的有趣事情...." type="textarea" :rows="5" maxLength="2000" show-word-limit/>
                    </div>
                    <!-- 生活指标 -->
